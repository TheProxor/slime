...
namespace TheProxor.Utils
{
	public static class SerializedPropertyExtensions
	{
		...
		public static T SerializedPropertyToObject<T>(this SerializedProperty property, bool includeAllBases = false)
		{
			return GetValue<T>(property, includeAllBases);
		}
		...
		/// <param name="property"></param>
		/// <returns>Returns the object type T if it is the type the property actually contains</returns>
		public static T GetValue<T>(this SerializedProperty property, bool includeAllBases = false)
		{
		...
		{
			if (property.serializedObject.targetObject is ScriptableObject scriptableObject) return scriptableObject;
		...
		public static T GetFieldOrPropertyValue<T>(
				string fieldName,
				object obj,
		...
		public static bool SetFieldOrPropertyValue(
				string fieldName,
				object obj,
				object value,
				bool includeAllBases = false,
